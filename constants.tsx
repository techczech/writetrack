...
const Edit3Icon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const ACTIVITY_TYPES: { [key in ActivityType]: { color: string; icon: React.FC<React.SVGProps<SVGSVGElement>>; hoverColor: string; } } = {
  [ActivityType.Writing]: { color: 'bg-blue-500', icon: PenIcon, hoverColor: 'hover:bg-blue-600' },
  [ActivityType.Editing]: { color: 'bg-orange-500', icon: Edit3Icon, hoverColor: 'hover:bg-orange-600' },
  [ActivityType.Planning]: { color: 'bg-purple-500', icon: ListIcon, hoverColor: 'hover:bg-purple-600' },
  [ActivityType.Review]: { color: 'bg-green-500', icon: SearchIcon, hoverColor: 'hover:bg-green-600' },
  [ActivityType.Research]: { color: 'bg-yellow-500', icon: BookOpenIcon, hoverColor: 'hover:bg-yellow-600' },
  [ActivityType.Setup]: { color: 'bg-gray-500', icon: SettingsIcon, hoverColor: 'hover:bg-gray-600' }
};
